...
class TreinoB : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_training_b)
        ...
        val loadImages: () -> Unit = {
            ...
            Firebase.storage.reference.child("img").listAll().addOnSuccessListener { list ->
                ...
                Log.e("TreinoB", "Erro ao acessar Storage: ${e.message}")

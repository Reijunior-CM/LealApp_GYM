...
class TreinoC : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_training_c)
        ...
        val loadImages: () -> Unit = {
            ...
            Firebase.storage.reference.child("img").listAll().addOnSuccessListener { list ->
                ...
                Log.e("TreinoC", "Erro ao acessar Storage: ${e.message}")
